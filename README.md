...
* **refresh** (timespan, optional, default 5s)
  ...
  down to an object and register definitions. If this value is lower than the target network can handle
  then newly scheduled read commands will be merged with those already queued.
